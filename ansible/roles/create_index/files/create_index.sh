...
curl -X PUT "43.204.205.20:9200/$1?pretty" -u $2:$3
...
' -u $2:$3
curl -X POST "43.204.205.20:5601/api/saved_objects/_import?createNewCopies=true" -H "kbn-xsrf: true" --form file=@./export.ndjson -u $2:$3
